...
public class MyController {
	...
	throws Exception{
		...
		if(pro.isPresent()) {
			...
			return ResponseEntity.status(HttpStatus.ACCEPTED).body(Map.of("message" , "Product has been updated "+product+update));
	...
	public ResponseEntity<?> deleteById(@PathVariable("id") Integer id){
		...
		if(product.isPresent()) {
			...
			return ResponseEntity.status(HttpStatus.ACCEPTED).body(Map.of("message" , "Product id = "+id+" have been deleted"));
		}
		return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of("message" , "Product id = "+id+" not found"));
	}
}
